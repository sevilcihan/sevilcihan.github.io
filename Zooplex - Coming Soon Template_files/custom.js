(function($){
	...
	$(document).ready(function() {
		...
		function createTimeCicles() {
		    var langDay = {tr:'gün', en:'days'}
			var langHour= {tr:'saat', en:'hours'}
			var langMin = {tr:'dakika', en:'minutes'}
			var langSec = {tr:'saniye', en:'seconds'}
			...
			countdown.TimeCircles({
				...
				circle_bg_color: '#bbb',
				time: {
    				    Days: {color: '#fff', text: langDay[lang]}
    			,	   Hours: {color: '#fff', text: langHour[lang]}
    			,	 Minutes: {color: '#fff', text: langMin[lang]}
    			,	 Seconds: {color: '#fff', text: langSec[lang]}
    			}
			});
			countdown.on('webkitAnimationEnd mozAnimationEnd oAnimationEnd animationEnd', function() {
        		countdown.removeClass('animated bounceIn');
